...
const UpdateYogaRetreat = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('http://localhost:9091/yogaretreat/updateyogaretreat/'+ params.id, formData)
            .then(response => {
                if (response.status == 200) {
...
export default UpdateYogaRetreat;
